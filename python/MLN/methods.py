...
class ParameterLearningMeasures:
    LL, PLL, BPLL, PLL_fixed, BPLL_fixed, NPL_fixed, LL_ISE, PLL_ISE, LL_ISEWW, E_ISEWW, SLL_ISE, DSLL_WW = range(12)
    ...
    _shortnames = {LL: "LL", PLL: "PLL", BPLL: "BPLL", PLL_fixed: "PLL_fixed", BPLL_fixed: "BPLL_fixed", NPL_fixed: "NPL_fixed", LL_ISE : "LL_ISE", PLL_ISE : "PLL_ISE", LL_ISEWW : "LL_ISEWW", E_ISEWW: "E_ISEWW", SLL_ISE: "SLL_ISE", DSLL_WW: "DSLL_WW"}
    _byName = dict([(x, y) for (y, x) in _names.iteritems()])