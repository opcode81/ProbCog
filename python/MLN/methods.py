...
class ParameterLearningMeasures:
    LL, PLL, BPLL, PLL_fixed, BPLL_fixed, NPL_fixed, LL_ISE, PLL_ISE, LL_ISEWW, SE_ISEWW, SLL_ISE, DSLL_ISEWW = range(12)
    _names = {LL: "log-likelihood",
              ...
              SE_ISEWW: "squared error with independent soft evidence and weighting of worlds",
    ...
    _shortnames = {LL: "LL", PLL: "PLL", BPLL: "BPLL", PLL_fixed: "PLL_fixed", BPLL_fixed: "BPLL_fixed", NPL_fixed: "NPL_fixed", LL_ISE : "LL_ISE", PLL_ISE : "PLL_ISE", LL_ISEWW : "LL_ISEWW", SE_ISEWW: "SE_ISEWW", SLL_ISE: "SLL_ISE", DSLL_ISEWW: "DSLL_ISEWW"}
    _byName = dict([(x, y) for (y, x) in _names.iteritems()])