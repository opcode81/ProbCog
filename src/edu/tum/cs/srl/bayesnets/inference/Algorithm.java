...
public enum Algorithm {
		...
		BackwardSampleSearch("backward SampleSearch", null, edu.tum.cs.bayesnets.inference.BackwardSampleSearch.class),
		BackwardSampleSearchBJ("backward SampleSearch with backjumping", null, edu.tum.cs.bayesnets.inference.BackwardSampleSearchBJ.class),
