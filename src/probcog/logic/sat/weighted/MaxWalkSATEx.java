...
import probcog.logic.sat.EvidenceHandler;
...
public class MaxWalkSATEx implements IMaxSAT {
    ...
    protected HashMap<probcog.logic.sat.weighted.WeightedClause, Formula> clFormula;
    ...
    public MaxWalkSATEx(WeightedClausalKB kb, PossibleWorld state, WorldVariables vars, Database evidence) throws Exception {
        ...
        for (probcog.logic.sat.weighted.WeightedClause c : kb) {
