...
import edu.tum.cs.bayesnets.core.relational.ABL;
...
public class learnABL {
	...
	public static void main(String[] args) {
		try {
			...
			if(blogFile == null || bifFile == null || dbFile == null || outFile == null) {
				System.out.println("\n usage: learnABL <-b <ABL file>> <-x <xml-BIF file>> <-t <training db>> <-o <output file>> [-s] [-d]\n\n"+
